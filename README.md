...
<p>This project is a battleships game that is run and played within the terminal. The system runs on a mock terminal through <a href="https://www.render.com/" target="_blank">render</a>
...
click here to play the game: <a href="https://python-project-gg2w.onrender.com" target="_blank">Battleship Game</a>
<br><br>
